...
**Chapter 2: One Second Before.** What happens in the brain immediately before a behavior. The amygdala, the frontal cortex, the interplay between automatic and controlled responses. When the amygdala detects a threat, it activates a response in milliseconds. The frontal cortex can override that response — but it takes longer.

**Chapter 3: Seconds to Minutes Before.** Hormones shape behavior on a slower time scale. Testosterone increases aggression — but only in certain contexts. Cortisol (stress hormone) affects the brain's sensitivity to threat. The same hormone can produce opposite effects depending on context.

**Chapter 4: Hours to Days Before.** The environment shapes behavior. Pain, hunger, exhaustion all lower the threshold for aggression. A judicial ruling is significantly harsher just before lunch than just after. Context matters.
...
**The Time Scale Framework:** The book is organized by how far in advance the causes of a behavior operate:
- One second: neuronal firing, amygdala, frontal cortex
- Seconds to minutes: hormones (testosterone, cortisol, oxytocin)
- Hours to days: environment (pain, hunger, heat, noise)
- Days to months: neuroplasticity, trauma, learning
- Months to years: childhood, adolescence, prenatal environment
- Generations: epigenetic inheritance
- Centuries: evolution, culture, gene-culture coevolution

**Key Brain Regions:** Amygdala (threat detection, automatic response), Frontal Cortex (executive control, impulse inhibition, long-term planning), Anterior Cingulate (conflict detection, pain perception), Insula (visceral sensation, empathy for pain), Dopamine System (reward, motivation, anticipation).

**Key Hormones:** Testosterone (increases aggression in competitive contexts), Cortisol (stress response, chronic stress damages the brain), Oxytocin (increases bonding with ingroup, hostility toward outgroup), Vasopressin (affects pair bonding in males).
...
|------|------|------------|
| Overview / "What is this book?" | ref 1 (The Book) + ref 2 (I) | Time scale. Behavior. Biology. |
| Free will / "Do we have it?" | ref 2 (II) + ref 3 (1) | Determinism. Criminal justice. Responsibility. |
| Aggression / "Why are people violent?" | ref 2 (III) + ref 3 (2) | Amygdala. Testosterone. Frontal cortex. |
| Empathy / "Why do we care?" | ref 2 (IV) + ref 3 (3) | Oxytocin. Mirror neurons. Insula. |
| Us vs. them / "Why do we divide?" | ref 2 (V) + ref 3 (4) | Ingroup. Outgroup. Tribalism. |
| Hormones / "What do they do?" | ref 2 (VI) + ref 3 (5) | Testosterone. Cortisol. Oxytocin. |
| Practical / "What can I apply?" | ref 3 (all 5) + ref 5 (5) | Understanding behavior. Context. |
...
- "We are only as good as our context. But we can shape our context."
